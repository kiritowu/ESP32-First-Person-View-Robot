...
static esp_err_t cmd_handler(httpd_req_t *req)
{
    ...
    else if (!strcmp(variable, "servo")) // 3250, 4875, 6500
    {
        ...
        if (val > 180)
            ...
            val = 0;
        ledcWrite(8, (((val / 180.0) * 2000) / 20000.0 * 65536.0) + 1634);
    }
    else
    {
    ...
    <figure>
      <div id="stream-container" class="image-container hidden">
        ...
        <section class="container">
            <div class='col-12'><button class='col-2 offset-5 btn btn-lg btn-light' onmousedown=getsend('go') onmouseup=getsend('stop') ontouchstart=getsend('go') ontouchend=getsend('stop')><i class='fa fa-chevron-up'></i></button></div><div class='col'><button class='btn btn-lg btn-light col-2 offset-3' onmousedown=getsend('left') onmouseup=getsend('stop') ontouchstart=getsend('left') ontouchend=getsend('stop')><i class='fa fa-chevron-left'></i></button><button class='btn btn-lg btn-light col-2 offset-2' onmousedown=getsend('right') onmouseup=getsend('stop') ontouchstart=getsend('right') ontouchend=getsend('stop')><i class='fa fa-chevron-right'></i></button></div><div class='col'><button class='btn btn-lg btn-light col-2 offset-5' onmousedown=getsend('back') onmouseup=getsend('stop') ontouchstart=getsend('back') ontouchend=getsend('stop')><i class='fa fa-chevron-down'></i></button></div></div>
            <section id="buttons" class='col-12'>
                <table>
                ...
                <tr><td></td><td align="center" colspan="2"></br></tr>
                <tr><td></td><td align="center" colspan="2"></br></tr>
                <tr><td class="text-white">Servo</td><td align="center" colspan="2"><input type="range" id="servo" min="0" max="90" value="45" step="1" onchange="try{fetch(document.location.origin+'/control?var=servo&val='+this.value);}catch(e){}"><td></td></tr>
                <tr><td class="text-white">Flash</td><td align="center" colspan="2"><input type="range" id="flash" min="0" max="255" value="0" onchange="try{fetch(document.location.origin+'/control?var=flash&val='+this.value);}catch(e){}"><td></td></tr>
                <tr><td class="text-white">Resolution</td><td align="center" colspan="2"><input type="range" id="framesize" min="0" max="6" value="5" onchange="try{fetch(document.location.origin+'/control?var=framesize&val='+this.value);}catch(e){}"><td></td></tr>
                <tr><td class="text-white">Quality</td><td align="center" colspan="2"><input type="range" id="quality" min="10" max="63" value="10" onchange="try{fetch(document.location.origin+'/control?var=quality&val='+this.value);}catch(e){}"><td></td></tr>
                </table>
            </section>         
        </section>
        <script>
